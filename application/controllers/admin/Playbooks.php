    ...
    public function setup_fields()
    {
        $this->formFields = array(
            'main' => array(
                ...
                'playbook_type_id'      => 'trim|strip_tags|numeric',
            ),
            'multi_selects' => array(
                'playbook_access_groups' => array(
                    'validation'        => 'trim',
                    'pivot_table'       => 'pivot_playbook_access_groups',
                    'main_field'        => 'playbook_id',
            ...
            'dynamic_fields' => array(
                'items' => array(
                    'table' => 'pivot_playbook_playbook_sections',
                    'parent_field' => 'playbook_id',
                    'fields' => array(
                        'playbook_section_id',
                        'position',
                    )
   ...
   public function quick_manage_extra($id, $row): array
    {
        return array(
            ...
            'available_playbook_sections'   => $this->{$this->model}->get_available_playbook_sections((int)$id, false),
            'playbook_sections'             => is_bool($id) ? [] : $this->{$this->model}->get_playbook_view((int)$id),
