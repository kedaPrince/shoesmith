 ...
 * Login Groups
 */
$config['login_groups'] = array(
    'admin' => array(
      'path'              => 'admin/',
      'table'             => 'usr_admins',
      'default_url'       => 'admin/dashboard',
      'super_user_id'     => 1,
      'session_fields'    => array('first_name', 'last_name', 'profile_image')
    ),
    'staff' => array(
      'path'              => 'staff/',
      'table'             => 'usr_staff',
...
//Captcha
//-1 : don't show, 0 : show always, 1+ show after x failed login attempts
$config['show_captcha'] = -1;
$config['recaptcha_site'] = '6Ld4BFIUAAAAAOd_8hAv4MCY3vqtk9fx4BKJ0VN5';
$config['recaptcha_secret'] = '6Ld4BFIUAAAAABT_ufy5hGuW1tFDeZiQeK8XvMn3';

//Allowed login attempts before blocking (0:disabled)
$config['block_login_attempts'] = 10;

//Time in hours to block
$config['block_login_time'] = 24;

//Send the user to the last page visited before logging out
$config['login_to_last_page'] = false;
...
//Email queue process limit
$config['mail_process_limit'] = 100;

//Reset Password Token Lifetime (in hours)
$config['reset_password_token_lifetime'] = 1;

//New User Password Token Lifetime (in hours)
$config['set_first_password_token_lifetime'] = 720;

//Default amount of rows to show on CRUD pages
$config['CRUD_row_limit'] = 30;

//The amount of result batches to be shown at one time on a page
$config['CRUD_batch_limit'] = 5;

//How often to check for new notifications in seconds (0 to disable)
...
/*
  ...
  |
 */
$config['error_views_path'] = 'application/views/cms/errors/';
...
/*
  ...
  |
 */
$config['encryption_key'] = 'ac53(*&%Y(&6E374*f6*^(HR^@3^^secr(';
...
$config['csrf_regenerate'] = FALSE; // This is what you want!
...
$config['cookie_samesite'] = 'Strict';  // Or 'Lax'
