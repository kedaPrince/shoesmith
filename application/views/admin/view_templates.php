...
<div class="hidden-templates">
        ...
        <div class="dz-preview dz-file-preview">
            ...
            <div class="dz-details">
                ...
                <div class="dz-controls">
                    ...
                    <div title="Caption" class="dz-caption dz-btn"><i class="fa fa-pencil"></i></div>
    ...
    <div class="image-caption-template">
        <?= field_input('xxx|label_caption|hide', '', 'image-caption-field', ['maxlength'=>64]); ?>
    </div>
