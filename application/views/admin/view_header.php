...
<!-- Top Level JS -->
<script type="text/javascript" src="<?= site_url(); ?>resources/cms/plugins/ckeditor5/custom/ecms-upload-adapter.js"></script>
...
<body data-theme="<?= $this->config->item('dark_mode') ? 'dark' : 'light'; ?>" data-color="<?= $this->config->item('theme'); ?>" class="font-nunito right_icon_toggle">
<script>
    //Set dark/light mode
