...
<div class="quick-manage-form-container qm-tabs">
    <div class="quick-manage-heading">
        ...
        if (empty($row)) {
            ...
            <p>
                Here you can <span>manage staff members</span> that have access to this system.<br />
                Once added, an Email will be sent to them with instructions to setup a password.
            </p>
            <?php
        } else {
            ?>
            <h2>Edit Staff Member <span><?= $row->first_name . ' ' . $row->last_name; ?></span></h2>
            <p>
                Here you can <span>edit staff members</span> that have access to this system.<br />
