...
<div class="quick-manage-form-container qmfc">
    <div class="quick-manage-heading">
        ...
        <p>In this module, you can manage the various access groups. You can assign access to users or revoke access to users of particular access groups</p>
    </div>
    <div class="form-field-container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <?= field_multi_select('admin_id|label_administrators', $admins_all, $admins); ?>
            </div>
        </div>
        <?php
        if ($this->seoFields) {
