            ...
            <div class="col-12">
                <div class="card">
                    <div class="header">
                        ...
                        <a href="<?php echo site_url('agency/chat/start'); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="body">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="chat-conversations-list">
                                    <div class="list-group">
                                        ...
                                        <a href="<?php echo site_url('agency/chat/conversation/' . $conversation->id); ?>"
                        ...
                        <div class="text-center p-4">
                            ...
                            <p class="text-muted">No conversations yet. Start a new conversation with a recruiter.</p>
                            <a href="<?php echo site_url('agency/chat/start'); ?>" class="btn btn-primary">
                                Start Conversation
                            </a>
                        </div>
                        <?php endif; ?>
