...
function initializeMultiSelects(container) {
    ...
    multiSelects.forEach(select => {
        ...
        if (typeof $.fn.select2 !== 'undefined') {
            ...
            console.log('Initializing with Select2:', name);
            $(select).select2({
                width: '100%',
        ...
        } else if (typeof $.fn.multiselect !== 'undefined') {
            // Use Bootstrap Multiselect if available
            console.log('Initializing with Bootstrap Multiselect:', name);
            $(select).multiselect({
            ...
            console.log('Using basic multi-select for:', name);
