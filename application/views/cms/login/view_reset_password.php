...
<body data-theme="<?= $this->config->item('dark_mode') ? 'dark' : 'light'; ?>"
                    ...
                    <div class="card">
                        ...
                        <div class="body form-auth-small reset-password-form">
                            ...
                            <div class="form-group">
                                ...
                                <input name="cpassword" type="password" class="form-control" id="signin-password"
                            ...
                            <button type="button" class="btn btn-primary btn-lg btn-block submit_button"
                                onclick="form_submit(this)">SUBMIT</button>
                            <?= form_close(); ?>
                        </div>
                    </div>
                </div>
    ...
    function isPasswordStrong(password, length = 10, containsSymbol = true, containsNumber = true, containsUppercase =
        ...
        if (containsNumber && !/[0-9]/.test(password)) {
            return false;
        }
        // Must contain a symbol
        if (containsSymbol && !/[^a-zA-Z0-9\s]/.test(password)) {
            return false;
        }
        // Password is strong
        return true;
