   ...
   public function get_template_with_sections($template_id) 
    {
        ...
        // Get the section associations from agency_template_sections
        $template_sections = $this->db->select('ats.section_id, ats.sort_order')
